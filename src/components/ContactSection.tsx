          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center space-x-3">
                <svg
                  className="w-5 h-5 text-modern-text-muted"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <a
                  ...
                  className="text-modern-text-muted hover:text-modern-text transition-colors"
                >
              ...
              <div className="flex items-center space-x-3">
                <a
                  href="https://wa.me/5511995132003"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center text-modern-text-muted hover:text-modern-text transition-colors"
                ...
                >
                  ...
                  <span className="align-middle">+55 11 99513-2003</span>
                </a>
              </div>
